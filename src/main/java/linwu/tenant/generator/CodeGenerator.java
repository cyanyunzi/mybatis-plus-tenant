package linwu.tenant.generator;
...
//    strategy.setSuperEntityColumns("id");
  ...
  public static String parentModelName(){
    return "linwu";
  }

  public static String outFileDiy(){
    return "E:\\code\\generator";
  }
}
